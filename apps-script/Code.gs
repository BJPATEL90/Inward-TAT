...
const CONFIG_DEFAULTS = Object.freeze([
  ...
  ["FACILITY_OWN", "OWN", "TEXT", "Canonical OWN ERP facility name for GRN and dashboard output."],
  ["FACILITY_EXPORT", "EXPORT", "TEXT", "Canonical EXPORT ERP facility name for GRN and dashboard output."],
  ...
  ["PUTAWAY_EXPORT_OWN", "GRN/Putaway-OWN", "TEXT", "Email export job mapped to OWN."],
  ["PUTAWAY_EXPORT_EXPORT", "GRN/Putaway-EXPORT", "TEXT", "Email export job mapped to EXPORT."],
  ["PUTAWAY_EXPORT_ARAMEX", "GRN/Putaway-ARAMEX", "TEXT", "ARAMEX ERP Putaway export mapped to dashboard facility EXPORT."],
  ...
  ["PUTAWAY_EMAIL_SUBJECT", "Export Job Complete - GRN/Gatepass to Putaway", "TEXT", "Shared subject for all Putaway facility exports, including ARAMEX."],
  ...
  ["EXPORT_BRIDGE_ENABLED", "TRUE", "TEXT", "Reclassifies SL Mother Hub unloading rows as EXPORT when GRN Number + SKU exists in the EXPORT GRN dump."],
  ["EXPORT_BRIDGE_FIELDS", "GRN_NUMBER|SKU", "TEXT", "EXPORT bridge used between Goods Inward, GRN and Putaway."],
